...
# Replace relu with elu to improve accuracy
...
# print(model.summary())
# 
# history = model.fit(X_train, y_train, epochs=30, validation_data=(X_valid, y_valid),validation_steps=200,
